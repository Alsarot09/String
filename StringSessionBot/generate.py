...
async def generate_session(bot, msg, telethon=False):
    await msg.reply(
        "**- استخـراج كـود {} بواسطـة 𝗛𝗨𝗡𝗧𝗘𝗥𝗧𝗛𝗢𝗡 جـارٍ...**".format(
